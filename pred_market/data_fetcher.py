...
def build_market_panel_sdk(min_volume: float = 50_000, max_markets: int = 300,
    ...
    if "--smoke-test" in sys.argv:
        ...
        if use_sdk:
            try:
                ...
                panel = build_market_panel_sdk(min_volume=100_000, max_markets=3, fidelity_minutes=60)
